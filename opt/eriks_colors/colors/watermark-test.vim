...
let g:watermark_Metadata = { 
            \"Name"        : "watermark",
            \"Maintainer"  : "Shawn Axsom",
			\"Email"       : "axs221@gmail.com",
            \"Version"     : "0.1b",
            \"Last Change" : "2008 Feb 28",
            \"URL"         : "http://www.vim.org/scripts/script.php?script_id=1454",
			\"License"     : ["Licensed under the Vim license"],
            \"Notes"       : ["    * Place :colo watermark in your VimRC/GVimRC file",
				\"    * GvimRC if using GUI any",
				\"    - Thanks to Desert and OceanDeep for their color scheme",
				\"    file layouts",
				\"    - Thanks to Raimon Grau for his feedback"],
			\"Palette"     : "red:yellow:blue:red:yellow:salmon:light blue:green:yellow:orange:lavender:brown:goldenrod4:dodger blue:pink:light green:gray10:gray30:gray75:gray90" }
"vim: sw=4
